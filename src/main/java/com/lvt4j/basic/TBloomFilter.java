...
public class TBloomFilter<E> implements Serializable {
    ...
    /**
      ...
      */
    public TBloomFilter(double c, int n, int k) {
     ...
     */
    public TBloomFilter(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public TBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public TBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final TBloomFilter other = (TBloomFilter) obj;        
